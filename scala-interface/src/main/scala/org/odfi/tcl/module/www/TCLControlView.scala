package org.odfi.tcl.module.www
           ...
           "ui bulleted list" ::  div  {
              TCLModule.errors.head match {
                case e: ExceptionInInitializerError =>
                  ...
                  e.getCause match {
                    case null =>
                    case cause: RuntimeException if (cause.getLocalizedMessage.contains("Failed to register class org.odfi.tcl.integration.TclintLibrary")) =>
                      "item" :: div {
