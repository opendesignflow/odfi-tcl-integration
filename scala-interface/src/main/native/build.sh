...
then
	...
	x86_64-w64-mingw32-g++ -I$loc/../../../target/native/tcl86/tcl8.6.5/generic -I./tcl86/ $MINGWLDFLAGS  $loc/TclInt.cpp -shared -static-libgcc -static-libstdc++  -ltcl86 -lstdc++   -Wl,-S,--subsystem,windows,--enable-runtime-pseudo-reloc,-no-undefined  -o $loc/../../../target/generated-resources/lib/win64/tclint.dll
